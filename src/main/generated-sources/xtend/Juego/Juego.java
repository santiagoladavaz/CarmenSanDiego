  ...
  public Juego() {
    ...
    final Procedure1<List<Pais>> _function = new Procedure1<List<Pais>>() {
      public void apply(final List<Pais> it) {
        ...
        ArrayList<String> _newArrayList_1 = CollectionLiterals.<String>newArrayList("Materos", "Con muchas playas");
        ...
        ArrayList<Lugar> _newArrayList_3 = CollectionLiterals.<Lugar>newArrayList(_embajada, _club, _biblioteca);
        Pais _pais = new Pais("Uruguay", _newArrayList_1, _newArrayList_2, _newArrayList_3);
        ArrayList<Pais> _newArrayList_4 = CollectionLiterals.<Pais>newArrayList(_pais);
        Banco _banco = new Banco();
        Biblioteca _biblioteca_1 = new Biblioteca();
        Club _club_1 = new Club();
        ArrayList<Lugar> _newArrayList_5 = CollectionLiterals.<Lugar>newArrayList(_banco, _biblioteca_1, _club_1);
        final Pais arg = new Pais("Argentina", _newArrayList, _newArrayList_4, _newArrayList_5);
        ArrayList<String> _newArrayList_6 = CollectionLiterals.<String>newArrayList("Caluroso", "Festivo");
        ...
        ArrayList<Lugar> _newArrayList_8 = CollectionLiterals.<Lugar>newArrayList(_banco_1, _biblioteca_2, _embajada_1);
        final Pais bra = new Pais("Brasil", _newArrayList_6, _newArrayList_7, _newArrayList_8);
        ArrayList<String> _newArrayList_9 = CollectionLiterals.<String>newArrayList("Lluvioso", "Extensos campos");
        ArrayList<Pais> _newArrayList_10 = CollectionLiterals.<Pais>newArrayList(arg);
        Banco _banco_2 = new Banco();
        Club _club_2 = new Club();
        Biblioteca _biblioteca_3 = new Biblioteca();
        ArrayList<Lugar> _newArrayList_11 = CollectionLiterals.<Lugar>newArrayList(_banco_2, _club_2, _biblioteca_3);
        final Pais cro = new Pais("Croacia", _newArrayList_9, _newArrayList_10, _newArrayList_11);
        ArrayList<String> _newArrayList_12 = CollectionLiterals.<String>newArrayList("Pobre", "Poca poblacion", "Cultivan cocos");
        ArrayList<Pais> _newArrayList_13 = CollectionLiterals.<Pais>newArrayList(bra, arg);
        Embajada _embajada_2 = new Embajada();
        Club _club_3 = new Club();
        Biblioteca _biblioteca_4 = new Biblioteca();
        ArrayList<Lugar> _newArrayList_14 = CollectionLiterals.<Lugar>newArrayList(_embajada_2, _club_3, _biblioteca_4);
        final Pais hai = new Pais("Haiti", _newArrayList_12, _newArrayList_13, _newArrayList_14);
        ArrayList<String> _newArrayList_15 = CollectionLiterals.<String>newArrayList("Forma de bota", "Comen pizza");
        ArrayList<Pais> _newArrayList_16 = CollectionLiterals.<Pais>newArrayList(cro, hai);
        Embajada _embajada_3 = new Embajada();
        Banco _banco_3 = new Banco();
        Biblioteca _biblioteca_5 = new Biblioteca();
        ArrayList<Lugar> _newArrayList_17 = CollectionLiterals.<Lugar>newArrayList(_embajada_3, _banco_3, _biblioteca_5);
        final Pais ita = new Pais("Italia", _newArrayList_15, _newArrayList_16, _newArrayList_17);
        ArrayList<String> _newArrayList_18 = CollectionLiterals.<String>newArrayList("Materos", "Con muchas playas");
        ArrayList<Pais> _newArrayList_19 = CollectionLiterals.<Pais>newArrayList(ita);
        Embajada _embajada_4 = new Embajada();
        Club _club_4 = new Club();
        Biblioteca _biblioteca_6 = new Biblioteca();
        ArrayList<Lugar> _newArrayList_20 = CollectionLiterals.<Lugar>newArrayList(_embajada_4, _club_4, _biblioteca_6);
        final Pais uru = new Pais("Uruguay", _newArrayList_18, _newArrayList_19, _newArrayList_20);
