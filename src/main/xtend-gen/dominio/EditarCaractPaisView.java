...
public class EditarCaractPaisView extends Dialog<Pais> {
  public EditarCaractPaisView(final WindowOwner owner, final Pais model) {
    super(owner, model);
    List<String> _caract = model.getCaract();
    _caract.add("hola");
  }
  ...
  protected void createFormPanel(final Panel mainPanel) {
    ...
    final Procedure1<Button> _function_1 = new Procedure1<Button>() {
      public void apply(final Button it) {
        ...
        final Action _function = new Action() {
          public void execute() {
            EditarCaractPaisView.this.getModelObject();
          }
        };
    ...
    _textBox.<ControlBuilder>bindValueToProperty("caractAAgregar");
      ...
      public void apply(final Button it) {
        ...
        final Action _function = new Action() {
          public void execute() {
            ...
            String _caractAAgregar = _modelObject_1.getCaractAAgregar();
            _modelObject.agregarCaract(_caractAAgregar);
          }
        };
        it.onClick(_function);
      }
